...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 80.21
  #define DEFAULT_bedKi 14.74
  #define DEFAULT_bedKd 290.89
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 140.20 }
...
#define NOZZLE_TO_PROBE_OFFSET { 48.9, -5.7, -2.555 } ////Minimus E3 with bltouch on right side
...
#define XY_PROBE_FEEDRATE (183*60)
